    ...
    <main>
        ...
        <div class="cart-section">
            ...
            <div class="cart-item">
                ...
                <p class="item-text">Basantapur</p>
                <a href="Booking/Basantapur.php?destination=Basantapur">
                    <button class="add-to-cart-btn">Book</button>
                </a>
            </div>
            <div class="cart-item">
                <img src="images/bihar.jpg" alt="Item 3" class="cart-image">
                <p class="item-text">Bihar</p>
                <a href="Booking/Bihar.php?destination=Bihar">
                    <button class="add-to-cart-btn">Book</button>
                </a>
            ...
            <div class="cart-item">
                ...
                <p class="item-text">Pathibhara mandir</p>
                <button class="add-to-cart-btn">Book</button>
            </div>
            <div class="cart-item">
